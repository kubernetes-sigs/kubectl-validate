...
func NewRootCommand() *cobra.Command {
	...
	invoked.localCRDsDir = res.Flags().StringSliceP("local-crds", "", []string{}, "--local-crds=./path/to/crds/dir. Path to a directory containing .yaml or .yml files for CRD definitions.")
